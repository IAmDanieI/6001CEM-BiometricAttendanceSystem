...
<head>
  ...
  <script>
    $(document).ready(function(){
      ...
      $(document).ready(function(){
  // Click event for user_rmo button
  $(".user_rmo").on("click", function() {
    var userConfirmed = confirm("Are you sure you want to remove this user?");
    if (userConfirmed) {
    ...
    return true;
      ...
      function validateForm() {
        return validateName() && validateFingerprintID() && validateSerialNumber() && validateEmail();
      }
...
<body>
  ...
  <input type="text" name="name" id="name" placeholder="Student Name..." oninput="validateName()">
  <input type="text" name="number" id="number" placeholder="Student Number..." oninput="validateSerialNumber()">
  <input type="email" name="email" id="email" placeholder="Student Email..." oninput="validateEmail()">
</fieldset>
        <fieldset>
        ...
        <button type="submit" name="user_add" class="user_add">Add Student</button>
